...
public class RealStats {
    ...
    /** Get the statistics on an n-dimensional
     *  real array.
     */
    ...
    private void computeDoubleNoise(double[] input) {
        ...
        for (int i=2; i<input.length-2; i += 1) {
            if (input[i-2] != Double.NaN &&
                input[i]   != Double.NaN &&
                input[i+2] != Double.NaN) {
    ...
    public static void main(String[] args) {
        ...
        double[][][] test = { { {1,2}, {2,3} }, { { 4, 5}, {6, Double.NaN} },
            { {10, 20}, {30,10} }, { {1,2}, {2,3} }, { { 4, 5}, {6, Double.NaN} },
            { {10, 20}, {30,10} } };
