 ...
 * and written that it is necessarily legal FITS.  These classes
 * try to make it easy to transform between arrays of Java primitives
 * and their FITS encodings.
 *
 *
 * <ul>
 ...
 *
 *
 * @version 1.10  September 27, 2012
 */
public class Fits {
    ...
    public static String version() {
        ...
        //              headers in Header.getDataSize(). This could return 1 rather than 0 if the
