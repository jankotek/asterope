...
public class BinaryTable extends Data implements TableData {
    ...
    /** Switched to an initial value of true TAM, 11/20/12, since the
     *  heap may be generated without any I/O.  In that case
     *  it's valid.  We set heapReadFromStream to false
     *  when we skip input.
     */
    ...
    public int addColumn(Object o) throws FitsException {
        ...
        System.out.println("Looking at o:"+o);

        int primeDim = Array.getLength(o);
        System.err.println("Primedim:"+primeDim);
