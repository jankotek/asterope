...
//omode=mode;
    ...
    private void createJpegAVMCalib(int width) {
      ...
      try {
       ...
       if( (s=(String)avm.get("Spatial.Rotation"))!=null )
       ...
       Enumeration e = avm.keys();
       while( e.hasMoreElements() ) {
          String key = (String)e.nextElement();
          String val = (String)avm.get(key);
          s = "COMMENT "+key+"="+val+"\n";
